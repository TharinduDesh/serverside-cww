...
<body>
    ...
    <p>
        ...
        <input type="text" name="headline" id="headline" maxlength="255"
    ...
    <p>
        ...
        <textarea name="biography" id="biography" rows="6"
            cols="60"><?= set_value('biography', isset($profile->biography) ? $profile->biography : ''); ?></textarea>
    </p>

    <p>
        <label for="linkedin_url">LinkedIn Profile URL</label><br>
        <input type="url" name="linkedin_url" id="linkedin_url" maxlength="255"
    ...
    <?php if (!empty($profile->profile_image)): ?>
        <p>Current Image:</p>
        <img src="<?= base_url($profile->profile_image); ?>" alt="Profile Image" style="max-width: 180px; height: auto;">
    <?php endif; ?>
    ...
    <p>
        ...
        <input type="text" name="programme" id="programme" value="<?= set_value('programme'); ?>"
        ...
        <table border="1" cellpadding="8" cellspacing="0">
            ...
            <?php foreach ($degrees as $degree): ?>
                <tr>
                    ...
                    <td>
                        <?= !empty($degree->programme) ? html_escape($degree->programme) : '-'; ?>
                    </td>
                    ...
                    <td>
                        ...
                        <a href="<?= site_url('profile/delete_degree/' . $degree->id); ?>"
    ...
    <p>
        ...
        <input type="text" name="certification_name" id="certification_name"
            value="<?= set_value('certification_name'); ?>">
    </p>
    ...
    <p>
        ...
        <input type="text" name="issuing_organization" id="issuing_organization"
            value="<?= set_value('issuing_organization'); ?>">
    </p>

    <p>
        <label for="certification_url">Course / Certification Page URL</label><br>
        <input type="url" name="certification_url" id="certification_url"
            value="<?= set_value('certification_url'); ?>">
    </p>

    <p>
        <label for="certification_completion_date">Completion Date</label><br>
        <input type="date" name="certification_completion_date" id="certification_completion_date"
            value="<?= set_value('certification_completion_date'); ?>">
    </p>
        ...
        <table border="1" cellpadding="8" cellspacing="0">
            ...
            <?php foreach ($certifications as $certification): ?>
                <tr>
                    ...
                    <td><?= !empty($certification->completion_date) ? html_escape($certification->completion_date) : '-'; ?>
                    </td>
                    <td>
                        <a href="<?= site_url('profile/edit_certification/' . $certification->id); ?>">Edit</a> |
                        <a href="<?= site_url('profile/delete_certification/' . $certification->id); ?>"
                            onclick="return confirm('Are you sure you want to delete this certification?');">Delete</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
    ...
    <p>
        ...
        <input type="date" name="licence_completion_date" id="licence_completion_date"
            value="<?= set_value('licence_completion_date'); ?>">
    </p>
            ...
            <?php foreach ($licences as $licence): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?= site_url('profile/delete_licence/' . $licence->id); ?>"
    ...
    <p>
        ...
        <input type="date" name="course_completion_date" id="course_completion_date"
            value="<?= set_value('course_completion_date'); ?>">
    </p>
            ...
            <?php foreach ($courses as $course): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?= site_url('profile/delete_course/' . $course->id); ?>"
    ...
    <p>
        <label for="industry_sector">Industry Sector</label><br>
        <input type="text" name="industry_sector" id="industry_sector" value="<?= set_value('industry_sector'); ?>"
        ...
        <table border="1" cellpadding="8" cellspacing="0">
            ...
            <?php foreach ($employment_history as $employment): ?>
                <tr>
                    ...
                    <td>
                        <?= !empty($employment->industry_sector) ? html_escape($employment->industry_sector) : '-'; ?>
                    </td>
                    <td>
                        <?= !empty($employment->location) ? html_escape($employment->location) : '-'; ?>
                    </td>
                    ...
                    <td>
                        ...
                        <a href="<?= site_url('profile/delete_employment/' . $employment->id); ?>"
