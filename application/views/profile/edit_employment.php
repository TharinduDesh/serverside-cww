...
<body>
    ...
    <p>
        ...
        <input type="text" name="company_name" id="company_name"
            value="<?= set_value('company_name', $employment->company_name); ?>">
    </p>

    <p>
        <label for="job_title">Job Title</label><br>
        <input type="text" name="job_title" id="job_title"
            value="<?= set_value('job_title', $employment->job_title); ?>">
    </p>

    <p>
        <label for="industry_sector">Industry Sector</label><br>
        <input type="text" name="industry_sector" id="industry_sector"
            value="<?= set_value('industry_sector', isset($employment->industry_sector) ? $employment->industry_sector : ''); ?>"
    ...
    <p>
        ...
        <input type="text" name="location" id="location"
            value="<?= set_value('location', isset($employment->location) ? $employment->location : ''); ?>"
    ...
    <p>
        ...
        <input type="date" name="start_date" id="start_date"
            value="<?= set_value('start_date', $employment->start_date); ?>">
    </p>
    ...
    <p>
        ...
        <textarea name="description" id="description" rows="4"
            cols="60"><?= set_value('description', $employment->description); ?></textarea>
    </p>
